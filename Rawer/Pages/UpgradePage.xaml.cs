...
namespace Rawer
{
    public partial class UpgradePage : PhoneApplicationPage
    {
        public UpgradePage()
        {
            ...
            this.Loaded += UpgradePage_Loaded;
        ...
        private void UpgradePage_Loaded(object sender, RoutedEventArgs e)
        {
            GoogleAnalytics.EasyTracker.GetTracker().SendView("UpgradePage");
        }

        private async void Button_BuyTap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            if (await InAppHelper.StartPurchase()) {
